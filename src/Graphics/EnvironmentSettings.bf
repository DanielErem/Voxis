namespace Voxis
{
	public struct EnvironmentSettings
	{
		...
		public EnvironmentData Data
		{
			get
			{
				var instance = EnvironmentData();
				instance.AmbientColor = AmbientColor.ToVector4();
				instance.Fog = Vector4(FogColor.R, FogColor.G, FogColor.B, FogDensity);
				instance.SunColor = SunColor.ToVector4();
				instance.SunDir = Vector4(SunDirection, 0);
				return instance;
			}
		}
