	...
	public class IconProgressBar : GUIElement
	{
		...
		public override void OnDraw(int currentDepth)
		{
			...
			if (BackgroundIcon != null)
			{
				...
				{
					CanvasRenderPipeline.DrawTexturedRect(Rect(currentX, currentY, BackgroundIcon.Width, BackgroundIcon.Height), BackgroundIcon, currentDepth, BackgroundTint);
			...
			if (ForegroundIcon != null)
			{
				...
				{
					CanvasRenderPipeline.DrawTexturedRect(Rect(currentX, currentY, ForegroundIcon.Width, ForegroundIcon.Height), ForegroundIcon, currentDepth, ForegroundTint);
