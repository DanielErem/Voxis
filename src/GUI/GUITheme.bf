namespace Voxis
{
	public class GUITheme
	{
		...
		public GUIStyle InventorySlotStyle { get; private set; }
		public GUIStyle InventorySlotHoveredStyle { get; private set; }
		...
		public ~this()
		{
			...
			delete InventorySlotStyle;
			delete InventorySlotHoveredStyle;
		}
		...
		public void OnLoad()
		{
			...
			Texture2D itemSlotBack = ResourceServer.LoadTexture2D("textures/gui/inventory_slot_background.png");
			InventorySlotStyle = new NineSliceStyle(itemSlotBack, .(4, 4, 4, 4));

			Texture2D itemSlotHoveredBack = ResourceServer.LoadTexture2D("textures/gui/inventory_slot_hovered_background.png");
			InventorySlotHoveredStyle = new NineSliceStyle(itemSlotHoveredBack, .(4, 4, 4, 4));
		}
	}
}
